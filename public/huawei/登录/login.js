ec.ready(function() {
			...
			$("#randomCodeImg").bind("error",function(){
				this.style.width='45px';
				this.src=localInfo.randomCodeImgLoading;
			})
			//登录
			...
			function login(paramObj, callbackFn) {
				...
				{
					if(typeof getRandomCode == "function")
					{	
					dataParms.authcode = getRandomCode();
					}
				}
			...
			function smsLogin(paramObj, callbackFn){
				var dataParms = {
					mobilePhone:$("#completePhoneNum").data('phone'),
		        ...
		        if(crossSiteModel == undefined)
		        {
		            querySiteInfo(dataParms.mobilePhone, function(){}, false);
		            crossSiteModel = localInfo.phoneCrossModel;
		        }
