...
<div class="qrdd" style="height: auto;" >
	<div class="container bg-success" >
		...
		<div class="col-md-12 qrdd_cen" style="height: auto;">
         ...
         <div class="left_cen">
             <img src="{{$v->pic}}" width="140" height="80">
             <ul class="list-unstyled list-inline">
                 <li><a href="#">{{$v->detail->title}}</a></li>
                 <li class="shu"><a href="#">{{$v->num}}</a></li>
                 <li class="jinqian"><a href="#">&yen;</a></li>
             </ul>
         </div>     
         @endforeach  
         <div class="left_bot">
      ...
      <div class="cen_right col-md-4" style="margin-left: 80px;">
                <div class="right_top">
