...
<div class="">
    ...
    <div class="col-md-12" style="height: auto;">
        <form class="am-form am-form-horizontal" action="/sysc/{{ $goods->id }}" method="post" enctype="multipart/form-data">
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-6 pull-left"  style="float:left;" >
                    <input type="text"  name="youhui" class="form-control border" value="{{ $goods->youhui }}">
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-6 pull-left"  style="float:left;" >
                    <input type="file"  name="pic" class="form-control border" multiple value="{{ $goods->pic }}">
                </div>
            </div>
