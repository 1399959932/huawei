...
<div class="">
    ...
    <div class="col-md-12" style="height: auto;">
        <form class="am-form am-form-horizontal" action="/admin/lbotu/{{$goods->id}}" method="post" enctype="multipart/form-data">

            <div class="top10"></div>
            <div class="am-form-group">
                <label class="am-u-sm-1 am-form-label text-info">图片</label>
