    	...
    	<form class="am-form am-form-horizontal" action="/roll" method="post" enctype="multipart/form-data">
            <div class="am-form-group">
                ...
                <div class="am-u-sm-6 pull-left"  style="float:left;">
                    <input type="text"  name="rollcontent" class="border form-contro" value="{{$roll->rollcontent}}">
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-6 pull-left"  style="float:left; font-size:16px;">
                  <span style="padding:0px 30px;margin-left:25px;">
                    <input type="radio" name="roll_pid" value="0"   @if($roll->roll_pid == 0) checked @endif>首页
                  </sapn>
                  <span style="padding:0px 30px;margin-left:25px;">
                    <input type="radio" name="roll_pid" value="1"   @if($roll->roll_pid == 1) checked @endif>华为专区
                  </sapn>
                  <span style="padding:0px 30px;margin-left:25px;">
                    <input type="radio" name="roll_pid" value="2"   @if($roll->roll_pid == 2) checked @endif>荣耀专区
                  </sapn>
                </div>
            </div>
            ...
            <div class="am-form-group">
                <div class="am-u-sm-3 am-u-sm-push-2 bg-info">
                    <button type="submit" class="am-btn am-btn-success col-md-12 border" >修改</button>
                </div>
            </div>
        </form>
    </div>
