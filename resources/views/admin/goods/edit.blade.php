    ...
    <div class="col-md-12" style="height: auto;">
    	<form class="am-form am-form-horizontal" action="/goods/{{$goods->id}}" method="post" enctype="multipart/form-data">
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-6 pull-left"  style="float:left;">
                    <input type="text" name="caontent" class="form-control border" value="{{$goods->content}}">
                </div>
            </div>
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-6 pull-left"  style="float:left;" >
                     <script id="editor" type="text/plain" name="details" style="width:754px;height:500px;">{{$goods->details}}</script>
                </div>
            </div>
