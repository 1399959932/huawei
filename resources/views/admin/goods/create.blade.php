    	...
    	<form class="am-form am-form-horizontal" action="/goods" method="post" enctype="multipart/form-data">
            <div class="am-form-group" >
                ...
                <div class="am-u-sm-6 pull-left">
                    <input type="text" id="user-name" name="title" class="form-control">
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-6 pull-left">
                    <input type="text" id="user-email" name="price" class="form-control">
                    <!-- <small>邮箱你懂得...</small> -->
                </div>
            </div>
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-6 pull-left" >
                    <input type=""  name="kuchun" class="form-control">
                </div>
            </div>
            ...
            <div class="am-form-group">
                <div class="am-u-sm-3 am-u-sm-push-2 bg-info">
                    <button type="submit" class="am-btn am-btn-success col-md-12" >添加</button>
                </div>
            </div>
        </form>
    </div>
